    ...
    WordSpec({
        "TypeReference.genericType" should {
                ...
                genericType shouldBe
                    mapOf(
                        "E" to
                            ClassContainer(
                                List::class,
                                mapOf("E" to ClassContainer(Int::class)),
                            ),
                    )
            }
            ...
            "return Double::class, Int::class" {
                ...
                genericType shouldBe
                    mapOf(
                        "T1" to ClassContainer(Double::class),
                        "T2" to ClassContainer(Int::class),
                    )
            }
            ...
            "find container type in list" {
                val clazz =
                    ClassContainer(
                        GenericTestClass::class,
                        mapOf("T1" to ClassContainer(Long::class), "T2" to ClassContainer(Float::class)),
                    )
                ...
                genericType shouldBe
                    mapOf(
                        ...
                        "V" to
                            ClassContainer(
                                List::class,
                                mapOf("E" to ClassContainer(Long::class)),
                            ),
                    )
            }
            ...
            "throw exception when clazz container type arguments don't match" {
                val clazz =
                    ClassContainer(
                        GenericTestClass::class,
                        mapOf("T1" to ClassContainer(Long::class), "T" to ClassContainer(Float::class)),
                    )
                val constructor = GenericTestClass::class.primaryConstructor!!
                val param = constructor.parameters[2] // List<Float>
                val type = param.type.javaType as ParameterizedType
